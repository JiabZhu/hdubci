        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-upload v-model:file-list="fileList" class="upload-demo"
              action="https://run.mocky.io/v3/9d059bf9-4660-45f2-925d-ce80ad6c4d15" :auto-upload="false" multiple
              :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" :limit="10000000000"
              :on-exceed="handleExceed">
              <el-button type="primary">Click to upload</el-button>
              <el-input v-model="fileList" autosize type="textarea" placeholder="Please input" />
            </el-upload>
