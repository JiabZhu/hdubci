      ...
      <el-main>
        ...
        <el-carousel :autoplay="false" indicator-position="outside" style="width:600px;margin:0px auto">
          <el-carousel-item v-for="item in 6" :key="item">
            ...
            <el-form :model="forms[item]" label-width="120px" style="margin-left:50px;margin-top:70px">
              <el-form-item label="设备类型">

                <el-select v-model="forms[item].type" class="m-2 deviceName" placeholder="Select">
...
export default defineComponent({
  ...
  setup() {
    ...
    return { form, onSubmit, options,forms}
  },
  components: {},
});
</script>
