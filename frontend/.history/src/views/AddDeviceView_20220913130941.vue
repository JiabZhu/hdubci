  ...
  <div class="home">
    <el-container>
      ...
      <el-main>
        ...
        <el-carousel :autoplay="false" indicator-position="outside" style="width:600px;margin:0px auto -20px">
        ...
        <el-button type="primary" style="position: absolute;left: 50%;margin-left: -16px;">连接</el-button>
      </el-main>
    </el-container>
  </div>
</template>
