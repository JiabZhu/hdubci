...
export default defineComponent({
  ...
  setup() {
    ...
    var target_pic_list_name:[];
    const handleTargetChange: UploadProps['onChange'] = (file, uploadFiles) => {
      target_pic_list_name.push(file.name)
    }
    const onSubmit = () => {
      form.experienceData.target_pic_list=target_pic_list_name;
