      ...
      <el-main>
        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-form ref="forms" :model="forms" label-width="120px" style="width: 50%">
              <el-form-item label="保存至文件夹">
                <input type="file" id="file" hidden @change="fileChange" webkitdirectory>
                <el-input placeholder="请输入内容" v-model="forms.imgSavePath" class="input-with-select">
...
export default defineComponent({
  ...
  setup() {
    ...
    return { form, onSubmit, formInline, forms }
  },
  methods: {
    fileChange(e:any) {
      try {
        ...
        if (fu == null) return
        this.forms.imgSavePath = fu.files[0].path
