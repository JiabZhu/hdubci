      ...
      <el-main>
        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-upload v-model:file-list="preparetionPic" class="upload-demo"
              ...
              <el-input v-model="preparetionPic?.name" autosize type="textarea" />
            </el-upload>
...
export default defineComponent({
  ...
  setup() {
    ...
    const preparetionPic=ref<UploadUserFile>();
    const fileList = ref<UploadUserFile[]>([

    ])
  
    return { form, onSubmit, formInline, fileList,preparetionPic}
  },
