  ...
  <div class="home">
    <el-container>
      ...
      <el-main>
        ...
        <el-carousel :autoplay="false" indicator-position="outside" style="width:600px;margin:50px auto 0px;">
          <el-carousel-item v-for="item in 6" :key="item" style="margin:auto">

            <el-form :model="form" label-width="120px" style="margin-left:50px">
