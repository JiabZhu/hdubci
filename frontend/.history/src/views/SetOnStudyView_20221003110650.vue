      ...
      <el-main>
        <div class="common-layout">
          <el-container>
            ...
            <el-main>
              <div class="demo-image__preview" style="width:100px;height:100px;float:left;margin-left:10px;margin-top:10px" id="viewerjs">
                <img style="width: 100px; height: 100px" v-for="url in imgUrl"
                :key="url" src=url/>
              </div>
              <!-- <div class="demo-image__preview" v-for="url in imgUrl" :key="url">
                <el-image style="width: 100px; height: 100px" :src=url :preview-src-list=srcList :initial-index="4" @click="inputUrl(url)"
                  fit="fill" /> -->
              <!-- <div name="fade"  v-for="url in imgUrl" :key="url">
...
export default defineComponent({
  ...
  setup() {
    ...
    imgUrl.value.push("https://fuss10.elemecdn.com/2/11/6535bcfb26e4c79b48ddde44f4b6fjpeg.jpeg")
