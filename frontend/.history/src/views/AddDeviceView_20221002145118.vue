    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-carousel :autoplay="false" indicator-position="outside" style="width:600px;margin:0px auto">
          <el-carousel-item v-for="(t, item) in 6" :key="item">

            <el-form :model="list[item]" label-width="120px" style="margin-left:50px;margin-top:100px">
              ...
              <!-- <el-form-item style="float:left;">
                <span>请求成功</span>
                <el-button type="primary" @click="onSubmit(list[item])">连接</el-button>
              </el-form-item> -->
        ...
        <el-button type="primary" style="position: absolute;left: 50%;margin-left: -16px;margin-top: 30px;"
          @click="gotoSetStudy()">完成</el-button>
      </el-main>
    </el-container>
  </div>
</template>
...
import { addDevice ,startOffStudy} from "@/request/api";
...
export default defineComponent({
  ...
  setup() {
    ...
    const gotoSetStudy = () => {
      ...
      let len=nexturl.split('/').length;
      if(nexturl.split('/')[len-2]=='rsvponline'){
      ...
      nexturl='/'+nexturl.split('/')[len-2]+'/setstudy';
      router.push(nexturl);
      }
    }
    return { onSubmit, options, ...toRefs(forms), resetForm, gotoSetStudy }
  },
  components: {},
});
</script>
