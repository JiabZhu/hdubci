      ...
      <el-main>
        <div class="common-layout">
          <el-container>
            ...
            <el-main>
              <div style="width:100px;height:100px;float:left;margin-left:10px;margin-top:10px" v-for="url in imgUrl"
                :key="url">
                <el-image style="width: 100px; height: 100px" :src=url fit="fill" />
              </div>

              <el-popover placement="top-start" trigger="click" v-for="url in imgUrl"
                :key="url">
                <!--trigger属性值：hover、click、focus 和 manual-->
                <a :href=url target="_blank" title="查看最大化图片">
