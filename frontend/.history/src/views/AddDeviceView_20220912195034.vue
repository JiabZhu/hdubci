      ...
      <el-main>
        ...
        <el-carousel :autoplay="false" indicator-position="outside" style="width:600px;margin:0px auto">
          <el-carousel-item v-for="item in 6" :key="item">
            ...
            <el-form :model="list[0]" label-width="120px" style="margin-left:50px;margin-top:70px">
              <el-form-item label="设备类型">

                <el-select v-model="list[0].type" class="m-2 deviceName" placeholder="Select">
              ...
              <el-form-item label="IP">
                <el-input v-model="list[0].ip" class="ip" />
              </el-form-item>
              <el-form-item label="端口号">
                <el-input v-model="list[0].port" class="ip" />
              </el-form-item>
