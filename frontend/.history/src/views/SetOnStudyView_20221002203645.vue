      ...
      <el-main>
        <div class="common-layout">
          <el-container>
            ...
            <el-main>
              <div style="width:100px;height:100px;float:left;margin-left:10px;margin-top:10px" v-for="url in imgUrl" :key="url">
                <el-image style="width: 100px; height: 100px" :src=url  :preview-src-list="url"
                  fit="fill" />
              </div>
            </el-main>
          </el-container>
