        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="非目标图片">
            ...
            <el-upload v-model:file-list="nonTargetList" class="upload-demo" :auto-upload="false" multiple
              :show-file-list="false" :limit="10000000000">
              <el-input v-model="checkNonTargetlength(nonTargetList)" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea"
                style="width:520px" />
            </el-upload>
...
export default defineComponent({
  ...
  setup() {
    ...
    // const 
    return { form, onSubmit, formInline, fileList, handleExceed, upload }
  },
  computed: {
    checklength() {
      var name = ""
