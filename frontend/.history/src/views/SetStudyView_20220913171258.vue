        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="目标图片">
            ...
            <el-upload v-model:file-list="fileList" class="upload-demo" :auto-upload="false" multiple
              :show-file-list="false" :rows="2" :limit="10000000000">
              <el-input v-model="checklength" autosize type="textarea" style="width:410px" />
            </el-upload>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { form, onSubmit, formInline, fileList }
  },
  computed: {
    checklength() {
      var name = ""
