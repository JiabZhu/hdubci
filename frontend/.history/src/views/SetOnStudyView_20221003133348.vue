...
export default defineComponent({
  ...
  setup() {
    ...
    imgUrl.value.push("blob:http://localhost:8080/6858d437-3796-43c1-ba2b-f46c0cd05e89")
    ...
    const base64ImgtoFile = (dataurl:any, filename = 'file') =>{
      ...
      socket.on('predict res', (msg) => {
        ...
        var url=base64ImgtoFile(t.pic)
        console.log(window.URL.createObjectURL(url))
        if (t.predict == 1) imgUrl.value.push(window.URL.createObjectURL(url))
      });
