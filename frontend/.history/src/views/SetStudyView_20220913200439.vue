        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="目标：非目标">
            ...
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
              <el-form-item>
                <el-input v-model="formInline.targetNum" />
              </el-form-item>
              <el-form-item label=":" style="margin-left:-20px;">
                <el-input v-model="formInline.nonTargetNum" />
              </el-form-item>
            </el-form>
          ...
          <el-form-item label="实验次数">
            <el-input style="width:410px;" v-model="formInline.time" />
          </el-form-item>
          ...
          <el-form-item label="目标mack值">
            ...
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
              <el-form-item>
                <el-input v-model="formInline.targetMark" />
              </el-form-item>
              <el-form-item label="非目标mark值">
                <el-input v-model="formInline.nonTargetMark" />
              </el-form-item>
            </el-form>
