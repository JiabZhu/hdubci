      ...
      <el-main>
        ...
        <el-form :model="experienceData" label-width="120px"
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-upload v-model:file-list="startImage" class="upload-demo" ref="file" :auto-upload="false" multiple :limit="1" :on-change="handleFixationChange">
          ...
          <el-form-item label="目标图片">
            ...
            <el-upload v-model:file-list="targetList" class="upload-demo" :auto-upload="false" multiple :on-Change="handleTargetChange"
          ...
          <el-form-item label="非目标图片">
            ...
            <el-upload v-model:file-list="nonTargetList" class="upload-demo" :auto-upload="false" multiple :on-Change="handleNonTargetChange"
              :show-file-list="false" :limit="10000000000">
          ...
          <el-form-item label="结束图片">
            ...
            <el-upload v-model:file-list="endImage" class="upload-demo" :auto-upload="false" multiple :limit="1" :on-Change="handleEndChange">
              <el-button type="primary">选择图像</el-button>
            </el-upload>
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleFixationChange: UploadProps['onChange'] = (file) => {
