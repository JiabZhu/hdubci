        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="目标：非目标">
            ...
            <el-form :inline="true" :model="form" class="demo-form-inline">
              <el-form-item>
                <el-input v-model="form.targetNum" />
              </el-form-item>
              <el-form-item label=":" style="margin-left:-20px;">
                <el-input v-model="form.nonTargetNum" />
              </el-form-item>
            </el-form>
          ...
          <el-form-item label="实验次数">
            <el-input style="width:410px;" v-model="form.time" />
          </el-form-item>
          ...
          <el-form-item label="目标mack值">
            ...
            <el-form :inline="true" :model="form" class="demo-form-inline">
              <el-form-item>
                <el-input v-model="form.targetMark" />
              </el-form-item>
              <el-form-item label="非目标mark值">
                <el-input v-model="form.nonTargetMark" />
              </el-form-item>
            </el-form>
          ...
          <el-form-item label="准备时间">
            <el-input style="width:410px;" v-model="form.p" />
          </el-form-item>

          <el-form-item label="刺激呈现时间">
            <el-input style="width:410px;" v-model="form.user" />
          </el-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    // const clearFiles = () =>{
    //   this.$refs.targetList.clearFiles();
    // }
    return { form, onSubmit, startImage, endImage, formInline, targetList, nonTargetList}
  },
  methods: {
