      ...
      <el-main>
        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="目标图片">
            ...
            <el-upload v-model:file-list="targetList" class="upload-demo" :auto-upload="false" multiple ref="targetList"
              :show-file-list="false" :limit="10000000000">
              <el-input v-model="checkStartlength" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea"
                style="width:520px" />
            </el-upload>
          ...
          <el-form-item label="非目标图片">
            ...
            <el-upload v-model:file-list="nonTargetList" class="upload-demo" :auto-upload="false" multiple
              :show-file-list="false" :limit="10000000000">
              <el-input v-model="checkEndLength" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea"
                style="width:520px" />
            </el-upload>
...
export default defineComponent({
  ...
  setup() {
    ...
    const clearFiles = () =>{
      targetList.value.clearFiles();
    }
    return { form, onSubmit, startImage, endImage, formInline, targetList, nonTargetList ,clearFiles}
  },
  computed: {
    checkStartlength() {
      var name = ""
