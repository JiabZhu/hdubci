      ...
      <el-main>
        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-upload v-model:file-list="fileList" class="upload-demo" :auto-upload="false" multiple :limit="1"
...
export default defineComponent({
  ...
  setup() {
    ...
    return { form, onSubmit, fileList, formInline, targetList, handleExceed, upload, nonTargetList,beforeRemove }
  },
  computed: {
    checkStartlength() {
      var name = ""
