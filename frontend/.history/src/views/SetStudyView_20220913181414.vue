      ...
      <el-main>
        ...
        <el-form :model="form" label-width="120px"
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-upload ref="upload" class="upload-demo" :limit="1" :on-exceed="handleExceedStart"
              :auto-upload="false">
              <template #trigger>
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-upload ref="uploadStart" class="upload-demo" :limit="1" :on-exceed="handleExceedStart"
              :auto-upload="false">
              <template #trigger>
                <el-button type="primary">选择</el-button>
              </template>
