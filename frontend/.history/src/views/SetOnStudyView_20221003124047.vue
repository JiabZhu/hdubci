      ...
      <el-main>
        <div class="common-layout">
          <el-container>
            ...
            <el-main>
              <div class="demo-image__preview" style="width:100px;height:100px;"  id="viewerjs">
                <img style="width: 100px; height: 100px;float:left;margin-left:10px;margin-top:10px" v-for="url in imgUrl"
                :key="url" :src=url />
              </div>
