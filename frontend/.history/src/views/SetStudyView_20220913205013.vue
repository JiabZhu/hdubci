      ...
      <el-main>
        ...
        <el-form :model="experienceData" label-width="120px"
          ...
          <el-form-item label="准备阶段图片">
            ...
            <el-upload v-model:file-list="startImage" class="upload-demo" :auto-upload="false" multiple :limit="1" :on-change="handleChange">
...
export default defineComponent({
  ...
  setup() {
    ...
    return { ...toRefs(form), onSubmit, startImage, endImage, targetList, nonTargetList,handleChange }
  },
  methods: {
